        ...
        <table class="table">
            ...
            <c:forEach items="${sanPhamList}" var="sanpham">
                <tr>
                    ...
                    <td>
                        <a href="/sanpham?action=edit&id=${sanpham.id}" methods="get" class="btn btn-danger" style="background-color: yellow;color: black">Edit</a>
                    </td>
                    <td>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="/sanpham?action=delete" method="get">
