...
public class Service {
    ...
    public Service(String serviceCode, String serviceName, int serviceArea, double serviceCost, int serviceMaxPeople,
                   int serviceTypeId, int rentTypeId) {
    ...
    public Service(String serviceCode, String serviceName, int serviceArea, double serviceCost, int serviceMaxPeople,
                   String standardRoom, String descriptionOtherConvenience, int numberOfFloors, int serviceTypeId,
                   int rentTypeId) {
        this.serviceCode = serviceCode;
        this.serviceName = serviceName;
        this.serviceArea = serviceArea;
    ...
    public Service(String serviceCode, String serviceName, int serviceArea, double serviceCost, int serviceMaxPeople,
                   String standardRoom, String descriptionOtherConvenience, double pollArea, int numberOfFloors,
                   int serviceTypeId, int rentTypeId) {
        this.serviceCode = serviceCode;
        this.serviceName = serviceName;
        this.serviceArea = serviceArea;
    ...
    public Service(int serviceId, String serviceCode, String serviceName, int serviceArea, double serviceCost,
                   int serviceMaxPeople, String standardRoom, String descriptionOtherConvenience, double pollArea,
                   int numberOfFloors, int serviceTypeId, int rentTypeId) {
